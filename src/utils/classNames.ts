/** Utility function to dynamically construct concatenated class names (Tailwind syntax) for HTML elements.
/** Arguments: It accepts a variable number of arguments of unknown type.
